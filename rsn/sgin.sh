...
# اسم شهادة المطورين
Certificate_Name="iPhone Distribution: abdaslam abdallah (QZ2G9Y95PZ)"

# مسار بروفايل
Profile_Path="/Applications/MAMP/htdocs/app4bd/app4bd/rsn/sgin.sh"

#مسار ملفات التطبيقات
IPAS_FOLDER="/Applications/MAMP/htdocs/app4bd/app4bd/rsn/files"

#عدد التكرارات المرادة
DUPLICATS_NUMBER="0"

# مسار استخراج الملفات بعد التوقيع
OUTPUT_DIR="/Applications/MAMP/htdocs/app4bd/app4bd"
